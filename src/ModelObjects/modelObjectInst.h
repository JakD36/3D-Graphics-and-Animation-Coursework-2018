...
class modelObjectInst: public modelObject{ // publically inherit from modelObject class
public:
    ...
    // however there is an increased overhead storing everything as vectors when you only need one of that object
    vector<glm::vec3> position;
    vector<glm::vec3> rotation;
    vector<glm::vec3> scale;
    
    virtual void render(glm::mat4&,glm::mat4&, lightStruct[], glm::vec3&); // Our pure virtual function for modelObjectInst
