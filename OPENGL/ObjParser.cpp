...
ObjParser::ObjParser(string name){
    this->name = name;
    out_vertices.clear();
    out_uvs.clear();
    out_normals.clear();
...
vector<glm::vec3> ObjParser::getVertices(){
    return out_vertices; // output vertices
}

vector<glm::vec2> ObjParser::getUvs(){
    return out_uvs; // output uvs
}

vector<glm::vec3> ObjParser::getNormals(){
    return out_normals; // output normals
}
